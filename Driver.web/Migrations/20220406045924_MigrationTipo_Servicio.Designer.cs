...
namespace Driver.web.Migrations
{
    ...
    [Migration("20220406045924_MigrationTipo_Servicio")]
    partial class MigrationTipo_Servicio
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Driver.web.Data.Entities.MDEventos", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Driver.web.Data.Entities.MDInventario", b =>
                {
                    ...
                    b.Property<double>("invet_pretotal")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Driver.web.Data.Entities.MDProducto", b =>
                {
                    b.Property<int>("id_product")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("product_act")
                        .HasColumnType("bit");

                    b.Property<string>("product_descr")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Driver.web.Data.Entities.MDRepuestos_Camion", b =>
                {
                    ...
                    b.Property<DateTime>("repcam_fecsal")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Driver.web.Data.Entities.MDRepuestos_Terceros", b =>
                {
                    b.Property<int>("id_repter")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("repter_cant")
                        .HasColumnType("int");

                    b.Property<double>("repter_costo")
                        .HasColumnType("float");

                    b.Property<string>("repter_desc")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("repter_fecreg")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("repter_fecsal")
                        .HasColumnType("datetime2");

                    b.HasKey("id_repter");

                    b.ToTable("Terceros_camion");
                });
            ...
            modelBuilder.Entity("Driver.web.Data.Entities.MDServicio_Cabecera", b =>
                {
                    ...
                    b.Property<int?>("id_ubigeo_llegada")
                        .HasColumnType("int");

                    b.Property<int?>("id_ubigeo_partida")
                        .HasColumnType("int");

                    b.Property<double>("servcab_canttotal")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Driver.web.Data.Entities.MDServicio_Detalle", b =>
                {
                    ...
                    b.Property<DateTime>("servdet_Fecreg")
                        .HasColumnType("datetime2");

                    b.Property<double>("servdet_cantdet")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Driver.web.Data.Entities.MDTipo_servicio", b =>
                {
                    b.Property<int>("id_tipserv")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("tipserv_act")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("tipserv_descr")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Driver.web.Data.Entities.MDViaticos_Cabecera", b =>
                {
                    ...
                    b.Property<string>("viatcab_desc")
                        .HasColumnType("nvarchar(max)");
